...
return {
  ...
  config = function()
    ...
    colors.error = get_hl_color("DiagnosticError", "foreground") or colors.error
    colors.warning = get_hl_color("DiagnosticWarn", "foreground") or colors.warning
    colors.info = get_hl_color("DiagnosticInfo", "foreground") or colors.info
    colors.hint = get_hl_color("DiagnosticHint", "foreground") or colors.hint
