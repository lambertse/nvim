return {
  ...
  -- Main DAP plugin
  {
    ...
    config = function()
      ...
      vim.keymap.set("n", "<C-S-F5>", dap.restart, { desc = "Debug: Restart" }) -- Ctrl+Shift+F5
      vim.keymap.set("n", "<F9>", dap.toggle_breakpoint, { desc = "Debug: Toggle Breakpoint" })
      vim.keymap.set("n", "<F10>", dap.step_over, { desc = "Debug: Step Over" })
      vim.keymap.set("n", "<F3>", dap.step_into, { desc = "Debug: Step Into" })
      vim.keymap.set("n", "<F4>", dap.step_out, { desc = "Debug: Step Out" }) -- Shift+F11

      -- Additional useful VS-style keymaps
      vim.keymap.set("n", "<C-F10>", dap.run_to_cursor, { desc = "Debug: Run to Cursor" }) -- Ctrl+F10
